...
const Women = () => {
  ...
  const shirtsData = products.filter(
    (product) =>
      product.subcategory === "Shirts" && product.category === "Women"
  );
  const pantsData = products.filter(
    (product) => product.subcategory === "Pants" && product.category === "Women"
  );
  const shoesData = products.filter(
    (product) => product.subcategory === "Shoes" && product.category === "Women"
  );
