  ...
  return (
    <>
      ...
      <div className="relative min-h-[50vh] sm:min-h-[60vh] bg-cover bg-center">
        <div className="women-featured hidden xs:block sm:hidden">
          <img
            src="/assets/new-womenswear-at-lama.webp"
            alt="Women's Collection Banner"
            className="w-full h-full object-cover"
          />
        </div>
        <div className="women-featured h-[50vh] sm:h-[60vh] xs:hidden sm:block">
          <img
            src="/assets/new-printed-shirts-for-women.jpg"
            alt="Women's Collection Banner"
            className="w-full h-full object-cover"
          />
        </div>
        ...
        <div className="absolute bottom-8 sm:bottom-12 left-1/2 w-full max-w-4xl -translate-x-1/2 text-center z-20">
          ...
          <Link
            to="/women"
            className="inline-block text-base sm:text-lg font-semibold text-pink-300 hover:text-pink-200 underline transition-colors duration-300 animate-slide-up delay-200"
          >
            Shop Now
          </Link>
        </div>
